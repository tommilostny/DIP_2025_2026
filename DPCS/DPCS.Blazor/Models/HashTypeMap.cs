...
public static class HashTypeMap
{
    // This is a subset of the most common hash types.
    // Run `hashcat --help` to see the full list of hundreds of supported modes.
    public static readonly Dictionary<int, string> Map = new()
    {
        ...
        { 3730, "Dahua NVR/DVR/HVR (md5($salt1.strtoupper(md5($salt2.$pass))))" },
        ...
        { 5720, "Cisco-ISE Hashed Password (SHA256)" },
        { 5800, "Samsung Android Password/PIN" },
        { 6000, "RIPEMD-160" },
        { 6050, "HMAC-RIPEMD160 (key = $pass)" },
        { 6060, "HMAC-RIPEMD160 (key = $salt)" },
        { 6100, "Whirlpool" },
        { 6211, "TrueCrypt 5.0+ PBKDF2-HMAC-RIPEMD160 + AES / Serpent / Twofish (legacy)" },
        { 6212, "TrueCrypt 5.0+ PBKDF2-HMAC-RIPEMD160 + AES-Twofish / Serpent-AES / Twofish-Serpent (legacy)" },
        { 6213, "TrueCrypt 5.0+ PBKDF2-HMAC-RIPEMD160 + AES-Twofish-Serpent / Serpent-Twofish-AES (legacy)" },
        { 6221, "TrueCrypt 5.0+ SHA512 + AES / Serpent / Twofish (legacy)" },
        { 6222, "TrueCrypt 5.0+ SHA512 + AES-Twofish / Serpent-AES / Twofish-Serpent (legacy)" },
        { 6223, "TrueCrypt 5.0+ SHA512 + AES-Twofish-Serpent / Serpent-Twofish-AES (legacy)" },
        { 6231, "TrueCrypt 5.0+ Whirlpool + AES / Serpent / Twofish (legacy)" },
        { 6232, "TrueCrypt 5.0+ Whirlpool + AES-Twofish / Serpent-AES / Twofish-Serpent (legacy)" },
        { 6233, "TrueCrypt 5.0+ Whirlpool + AES-Twofish-Serpent / Serpent-Twofish-AES (legacy)" },
        { 6241, "TrueCrypt 5.0+ PBKDF2-HMAC-RIPEMD160 + AES / Serpent / Twofish + boot (legacy)" },
        { 6242, "TrueCrypt 5.0+ PBKDF2-HMAC-RIPEMD160 + AES-Twofish / Serpent-AES / Twofish-Serpent + boot (legacy)" },
        { 6243, "TrueCrypt 5.0+ PBKDF2-HMAC-RIPEMD160 + AES-Twofish-Serpent / Serpent-Twofish-AES + boot (legacy)" },
        { 6300, "AIX {smd5}" },
        { 6400, "AIX {ssha256}" },
        { 6500, "AIX {ssha512}" },
        ...
        { 10510, "PDF 1.3 - 1.6 (Acrobat 4 - 8) w/ RC4-40" },
        ...
        { 13400, "KeePass 1/2 AES/Twofish with/without keyfile" },
        { 13500, "PeopleSoft PS_TOKEN" },
        { 13600, "WinZip" },
        { 13711, "VeraCrypt PBKDF2-HMAC-RIPEMD160 + AES / Serpent / Twofish (legacy)" },
        { 13712, "VeraCrypt PBKDF2-HMAC-RIPEMD160 + AES-Twofish / Serpent-AES / Twofish-Serpent (legacy)" },
        { 13713, "VeraCrypt PBKDF2-HMAC-RIPEMD160 + Serpent-Twofish-AES (legacy)" },
        { 13721, "VeraCrypt" },
        { 13722, "VeraCrypt PBKDF2-HMAC-SHA512 + AES-Twofish / Serpent-AES / Twofish-Serpent (legacy)" },
        { 13723, "VeraCrypt PBKDF2-HMAC-SHA512 + Serpent-Twofish-AES (legacy)" },
        { 13731, "VeraCrypt PBKDF2-HMAC-Whirlpool + AES / Serpent / Twofish (legacy)" },
        { 13732, "VeraCrypt PBKDF2-HMAC-Whirlpool + AES-Twofish / Serpent-AES / Twofish-Serpent (legacy)" },
        ...
        { 13742, "VeraCrypt PBKDF2-HMAC-RIPEMD160 + boot-mode + AES-Twofish / Serpent-AES / Twofish-Serpent (legacy)" },
        { 13743, "VeraCrypt PBKDF2-HMAC-RIPEMD160 + boot-mode + AES-Twofish-Serpent / Serpent-Twofish-AES (legacy)" },
        { 13751, "VeraCrypt PBKDF2-HMAC-SHA256 + AES / Serpent / Twofish (legacy)" },
        { 13752, "VeraCrypt PBKDF2-HMAC-SHA256 + AES-Twofish / Serpent-AES / Twofish-Serpent (legacy)" },
        { 13753, "VeraCrypt PBKDF2-HMAC-SHA256 + Serpent-Twofish-AES (legacy)" },
        { 13761, "VeraCrypt PBKDF2-HMAC-SHA256 + boot-mode + Twofish / PIM + AES (legacy)" },
        ...
        { 21900, "md5(md5(md5($pass.$salt1)).$salt2)" },
        ...
        { 22800, "Simpla CMS - md5($salt.$pass.md5($pass))" },
        ...
        { 24000, "BestCrypt v4 Volume Encryption" },
        ...
        { 29511, "LUKS v1 SHA-1 + AES / Serpent / Twofish" },
        ...
        { 31900, "MataMask Mobile Wallet" },
        { 32000, "NetIQ SSPR (MD5)" },
        { 32010, "NetIQ SSPR (SHA1)" },
        { 32020, "NetIQ SSPR (SHA-1 with Salt)" },
        { 32030, "NetIQ SSPR (SHA-256 with Salt)" },
        { 32031, "Adobe AEM (SSPR, SHA-256 with Salt)" },
        { 32040, "NetIQ SSPR (SHA-512 with Salt)" },
        { 32041, "Adobe AEM (SSPR, SHA-512 with Salt)" },
        { 32050, "NetIQ SSPR (PBKDF2WithHmacSHA1)" },
        { 32060, "NetIQ SSPR (PBKDF2WithHmacSHA256)" },
        { 32070, "NetIQ SSPR (PBKDF2WithHmacSHA512)" },
        ...
        { 32700, "Kremlin Encrypt 3.0 w/NewDES" },
        { 32800, "md5(sha1(md5($pass)))" },
        { 32900, "PBKDF1-SHA1" },
        { 33100, "md5($salt.md5($pass).$salt)" },
        { 33300, "HMAC-BLAKE2S (key = $pass)" },
        { 33400, "mega.nz password-protected link (PBKDF2-HMAC-SHA512)" },
        { 33600, "RIPEMD-320" },
        { 33650, "HMAC-RIPEMD320 (key = $pass)" },
        { 33660, "HMAC-RIPEMD320 (key = $salt)" },
        { 33700, "Microsoft Online Account (PBKDF2-HMAC-SHA256 + AES256)" },
        { 33800, "WBB4 (Woltlab Burning Board) [bcrypt(bcrypt($pass))]" },
        { 33900, "Citrix NetScaler (PBKDF2-HMAC-SHA256)" },
        { 34000, "Argon2" },
        { 34200, "MurmurHash64A" },
        { 34201, "MurmurHash64A (zero seed)" },
        { 34211, "MurmurHash64A truncated (zero seed)" },
        { 34400, "sha224(sha224($pass))" },
        { 34500, "sha224(sha1($pass))" },
        { 34600, "MD6 (256)" },
        { 34800, "BLAKE2b-256" },
        { 34810, "BLAKE2b-256($pass.$salt)" },
        { 34820, "BLAKE2b-256($salt.$pass)" },
        { 35000, "SAP CODVN H (PWDSALTEDHASH) isSHA512" },
        { 35100, "sm3crypt $sm3$, SM3 (Unix)" },
        { 35200, "AS/400 SSHA1" },
        { 70000, "Argon2id [Bridged: reference implementation + tunings]" },
        { 70100, "scrypt [Bridged: Scrypt-Jane SMix]" },
        { 70200, "scrypt [Bridged: Scrypt-Yescrypt]" },
        { 72000, "Generic Hash [Bridged: Python Interpreter free-threading]" },
        { 73000, "Generic Hash [Bridged: Python Interpreter with GIL]" },
        { 74000, "Generic Hash [Bridged: Rust]" },
        { 99999, "Plaintext" }
    };

    public static string GetHashTypeName(int id)
    {
