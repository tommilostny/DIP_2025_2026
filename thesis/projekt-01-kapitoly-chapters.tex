...
\section{Kdy a jak psát Abstrakt}
...
\section{Doporučená struktura abstraktu}
...
\section{Inovace není Ignorance}
...
\section{Klíčová slova -- půl úspěchu}
...
\section{Příliš obecný nadpis, příliš specifický nadpis}
...
\subsection{Obecné rady dle doc. Berana}
Tato podkapitola byla převzata ze stránek doc. Berana \cite{Beran}, \cite{BeranPDF}.
...
\subsection{Obecné rady od prof. Černockého}

Tato podkapitola je převzata ze stránek prof. Jana Černockého \cite{Cernocky}.
...
Není-li uvedeno jinak, zbytek této kapitoly je převzat z osobních stránek prof. Zemčíka~\cite{Zemcik}, blogů prof. Herouta~\cite{Herout} a dr. Szökeho~\cite{rady} a dále ze stránek prof. Černockého~\cite{Cernocky} a~doc. Berana~\cite{Beran}.
...
\subsection{Rady pro teoretickou část od prof. Černockého}
...
\subsection{Rady pro teoretickou část od doc. Berana}
...
\subsection{Rady pro návrh a popis Vašeho algoritmu od~prof. Černockého}
...
\subsection{Rady pro návrh řešení od doc. Berana}
...
\subsection{Rady pro implementaci od prof. Černockého}
...
\subsection{Rady pro popis implementace od doc. Berana}
...
\subsection{Rady pro obsah kapitoly o testování od prof. Černockého}
...
\subsection{Rady pro experimentování od doc. Berana}
...
\subsection{Rady pro Závěr od prof. Černockého}
...
\subsection{Rady pro Závěr od doc. Berana}
...
\subsection{Rady k obsahu příloh od prof. Černockého}   
...
Pravidla pro vytváření bibliografických citací a jejich uvádění v odborných publikacích upravuje norma ČSN ISO 690:2022 (Informace a dokumentace - Pravidla pro bibliografické odkazy a citace informačních zdrojů) z roku 2022. Norma je dostupná v knihovně FIT. Nástroj pro generování citací podle těchto norem
...
\hline
 ...
 &  &  & přesáhnout  \\ \hline
Bakalářská práce & 40 & 60--80 & 100 \\ \hline
...
Bakalářská či diplomová práce se odevzdává v listinné a v elektronické formě, kde elektronická forma se odevzdává do úložiště Nextcloud. Za odevzdanou se považuje až ve chvíli, kdy jsou korektně odevzdány obě formy práce. Tato kapitola je do značné míry převzata z oficiálních pokynů na~webu \cite{formalniBP}, \cite{formalniDP}.

Ti, kteří se rozhodli utajit některé části práce, o to musí min. měsíc před odevzdáním podat žádost. Do obou výtisků se volně vloží papír s oznámením, že se~jedná o utajovaný výtisk, na kterém bude vyznačena doba trvání překážky pro zveřejnění (které však lze odložit nejdéle na dobu 5 let). 
...
Odevzdává se jeden výtisk bakalářské či diplomové práce. Tento výtisk bude obsahovat podepsané prohlášení a musí být svázán nerozebíratelným způsobem. Doporučeny jsou desky z polotvrdého papíru, tmavé (modrá, šedá). Pokud byl povolen odklad zveřejnění, na vnitřní straně zadní desky bude vlepena obálka s CD/DVD či jiným povoleným nosičem tak, aby bylo možné jej vyjmout. 
...
V případě, že byl povolen odklad zveřejnění, kompletní elektronická podoba musí být přiložena na nepřepisovatelném paměťovém médiu CD-R, DVD-R, DVD+R ve formátu ISO9660 (s rozšířením RockRidge a/nebo Jolliet) nebo UDF nebo paměťové kartě SD (Secure Digital) ve formátu FAT32 nebo exFAT s~nastavenou ochranou proti přepisu. 
